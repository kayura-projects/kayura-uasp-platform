...
@MappedTypes(ExtendFields.class)
...
public class ExtendFieldListTypeHandler extends JsonTypeHandler<ExtendFields> {

  public ExtendFieldListTypeHandler() {
    super(ExtendFields.class);
  }
